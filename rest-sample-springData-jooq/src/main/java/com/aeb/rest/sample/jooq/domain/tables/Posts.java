 ...
 */
package com.aeb.rest.sample.jooq.domain.tables;


import com.aeb.rest.sample.jooq.domain.Keys;
import com.aeb.rest.sample.jooq.domain.Public;
import com.aeb.rest.sample.jooq.domain.enums.PostsPostStatus;
import com.aeb.rest.sample.jooq.domain.tables.records.PostsRecord;
...
public class Posts extends TableImpl<PostsRecord> {
     ...
     */
    public final TableField<PostsRecord, PostsPostStatus> POST_STATUS = createField(DSL.name("POST_STATUS"), SQLDataType.VARCHAR.asEnumDataType(com.aeb.rest.sample.jooq.domain.enums.PostsPostStatus.class), this, "");
